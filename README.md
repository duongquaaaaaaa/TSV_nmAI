...
# Xem AI Phase 3 đánh với bot nghiệp dư (mê cung)
...
| **Seeds** | 5 ván/cá thể |
| **Ngưỡng thăng hạng** | 450 điểm (streak 10 gen) |
...
| **Ngưỡng thăng hạng** | 420 điểm (streak 10 gen) |
...
| **Khiên** | **TẮT** (Bị vô hiệu hóa trong môi trường train) |
| **Đạn** | Tồn tại 3.5s, tối đa 3 viên |
| **Ngưỡng thăng hạng** | 360 điểm (streak 7 gen) |
...
| Thuộc tính | Giá trị |
|---|---|
| **Đối thủ** | Rule V3 — Sniper Boss (ngắm chuẩn ~0.1 rad, dừng xe bắn, không dùng khiên) |
| **Bản đồ** | Normal (mê cung) |
| **Đạn** | Tồn tại 7s, tối đa 3 viên |
| **Ngưỡng thăng hạng** | 400 điểm (streak 10 gen) |
| **League mixing** | 50% trộn Rule V2 (ôn chiến đấu, giảm sốc đầu phase) |
...
Phase 4: 50% trộn Rule V2 (bắn nghiệp dư)   → Ôn chiến đấu cơ bản
...
| **22** | Shield Active | Khiên đang bật? (Bị vô hiệu hóa) | {0} |
| **23** | Shield Cooldown | 1 − (thời gian chờ / 15s) (Bị vô hiệu hóa) | [1.0] |
...
| **4** | sigmoid > 0.5 | Bắn |
| **5** | sigmoid > 0.5 | Khiên (Bị vô hiệu hóa trong lúc train) |
...
### Phase 1–4: Dense Reward (Cầm tay chỉ việc)
...
- Thưởng di chuyển về hướng A* waypoint: `(fwdSpeed/maxSpeed) × 5.0 × dt`
- Phạt đứng im khi chưa thấy địch: -2.0 × dt
- Phạt xoay tít mù (beyblade): -4.0 × dt

**ENGAGEMENT MODE** (thấy địch ≤ 8m):
- **Ngắm bắn** — Tín hiệu chính:
  - Sweet spot (3–8m): `dotAim × 5.0 × dt` (thưởng mạnh nhất)
  - Gần (< 3m): `dotAim × 2.0 × dt`
  - Xa (> 8m): `dotAim × 1.0 × dt`
- **Quản lý khoảng cách**:
  - Gần 1.8–3m: không phạt, không thưởng
  - Quá gần < 1.8m: phạt kamikaze -5.0 × dt

**Kỷ luật (mọi lúc):**
- Phạt húc tường: -5.0 × dt (nếu đang tiến)
- Thưởng lùi khi sát tường: +0.8 × dt
- Anti-retreat (Phase 3+): Phạt đi lùi khi thấy địch ở sweet spot

**Xạ thủ:**
- Bắn chuẩn (dotAim > 0.85, thấy địch, < 10m): +7.0 ~ 8.0 × dt
- Bắn bừa / không thấy địch: phạt -2.5 ~ -3.0 × dt

#### End-of-Episode Bonus

| Kết quả | Điểm | Ghi chú |
|---|:---:|---|
| **Thắng (Real Kill)** | +400 + timeBonus×300 + 50 (có bắn) | Tự tay bắn chết địch |
| **Thắng (Fake Win)** | +100 | Địch tự tử do đạn nảy |
| **Hòa** (hết giờ, có chiến đấu) | -250 | Ép phải giết địch |
| **Hòa** (P3, không bắn phát nào) | -500 | Rùa rụt cổ bị phạt nặng nhất |
| **Chết** | -400 | Tệ nhưng vẫn tốt hơn rùa rụt cổ |

**Thang điểm ưu tiên**: Thắng Thực Sự (+400~750) > Địch Tự Tử (+100) > Hòa có bắn (-250) > Chết (-400) > Rùa rụt cổ (-500)

### Phase 5: Sparse Reward (Luật rừng)

Step reward chỉ giữ các lệnh trừng phạt hành vi ngớ ngẩn (chống húc tường, chống đứng im, chống quay vòng tròn). 

End-of-episode bonus quyết định 99% kết quả:
- **Thắng (Real Kill)**: +500 + timeBonus × 500
- **Thắng (Fake Win)**: +100
- **Thua/Hòa**: -500
